...
/^[ 	]*CompositeIOD=/ {
	...
	if (role == "declare") {
		...
		print "bool"
		print "CompositeIOD_" iodcomp "::verify(AttributeList *list,bool verbose,bool newformat,bool allpffgitems,TextOutputStream& log,ElementDictionary *dict) const"
		print "{"
...
/^[ 	]*CompositeIODEnd/ {
	...
	if (role == "declare") {
		...
		print "\tbool        verify(AttributeList *list,bool verbose,bool newformat,bool allpffgitems,TextOutputStream& log,ElementDictionary *dict) const;"
		print "};"
		print ""
	}
	else if (role == "build") {
...
/^[ 	]*Module/ {
	...
	if (role == "declare") {
		...
		print "\tif (" module " && !" module "->verify(list,NULL/*parentlist*/,list/*rootlist*/,verbose,newformat,allpffgitems,log,dict)) success=false;"
		print "\tif (verbose)"
